...
int main()
{
	...
	T1nameGenerator->SetDirectory(/*"C:\\Users\\Administrator\\Desktop\\devide\\zhangmengmeng500\\concon\\2zhangnmengmeng500SEGandFILL"*/"C:\\Users\\Administrator\\Desktop\\devide\\zhangmengmeng500\\concon\\2zhangnmengmeng500SEGandFILL");
...
//	T2nameGenerator->AddSeriesRestriction("0008|0021" );
	...
	T2nameGenerator->SetDirectory("C:\\Users\\Administrator\\Desktop\\devide\\zhangmengmeng500\\concon\\8zhangmengmeng500SEGandFILL");
...
void registion()//局部配准
{
	...
	optimizer->SetLearningRate( 0.4 );//阻尼系数学习率?
	optimizer->SetMinimumStepLength( 0.0001 );///收敛域的公差
...
void allregistion()//全局配准读入并处理全局图像
{
	...
	allT1nameGenerator->SetDirectory( "C:\\Users\\Administrator\\Desktop\\devide\\zhangmengmeng500\\ludi\\2zhangmengmeng"/*"C:\\Users\\Administrator\\Desktop\\devide\\square1"*/);
	...
	allT2nameGenerator->SetDirectory(/*"C:\\Users\\Administrator\\Desktop\\devide\\square2"*/ "C:\\Users\\Administrator\\Desktop\\devide\\zhangmengmeng500\\ludi\\8zhangmengmeng");
...
void saveresulttodicom()//配准后将结果保存成dicom
{
  ...
  NamesGeneratorType::Pointer namesGeneratorf = NamesGeneratorType::New();
   ...
   namesGeneratorf->SetInputDirectory("C:\\Users\\Administrator\\Desktop\\niuxiahe\\maruohan-data\\Zhang Mengmeng (R)\\Zhang Mengmeng (R)\\zhangmengmeng20160817R\\ECIX3BKE\\CC1ZTGXR"/*"C:\\Users\\Administrator\\Desktop\\devide\\haolinlin500\\testsquare12"*/ );//注意这里是反的
 ...
 // typedef itk::Image< PixelType, Dimension >      ImageType;
  ...
  NamesGeneratorType::Pointer namesGenerator = NamesGeneratorType::New();
   namesGenerator->SetInputDirectory("C:\\Users\\Administrator\\Desktop\\niuxiahe\\maruohan-data\\Zhang Mengmeng (R)\\Zhang Mengmeng (R)\\zhangmengmeng20160226R\\OU5R03VY\\WHPEAETD" /*"C:\\Users\\Administrator\\Desktop\\devide\\haolinlin500\\testsquare8"*/);
 ...
 /* typedef itk::ResampleImageFilter<
	...
	resamplerdicom->SetOutputDirection( fixedImagenew->GetDirection() );
	  ...
	  if(num ==0)
	  {
		 outputDirectory = "C:\\Users\\Administrator\\Desktop\\result\\conresamper";
	  }
	  if(num!=0)
	  {
		 outputDirectory = "C:\\Users\\Administrator\\Desktop\\result\\ludiresamper";
	  }
  ...
  typedef itk::SubtractImageFilter<
	...
	if(num==0)
	{
		outputDirectory2 = "C:\\Users\\Administrator\\Desktop\\result\\condiff";
	}
	if(num!=0)
	{
		outputDirectory2 = "C:\\Users\\Administrator\\Desktop\\result\\ludidiff";
	}
  ...
  if(num==0)
  {
	...
	const char * outputDirectory3;
	 ...
	 outputDirectory3 = "C:\\Users\\Administrator\\Desktop\\result\\oridiff";
